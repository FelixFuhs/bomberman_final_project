...
def optimize_model(self):
    ...
    # Convert the list of states and non-final next states to numpy arrays before converting to tensors
    ...
    non_final_next_states = torch.from_numpy(non_final_next_states).to(self.device)
